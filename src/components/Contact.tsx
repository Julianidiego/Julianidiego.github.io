...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Aquí normalmente enviarías el formulario a un servicio de backend
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            ¿Tienes un proyecto en mente? ¿Buscas un desarrollador para tu equipo? Ponte en contacto conmigo.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:correo@example.com" className="text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400">
                      correo@example.com
                    </a>
                  </div>
                </div>
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow-md">
              ...
              {formStatus && (
                <div className={`mb-6 p-4 rounded-md ${formStatus.isError ? 'bg-red-50 dark:bg-red-900/30 text-red-800 dark:text-red-200' : 'bg-green-50 dark:bg-green-900/30 text-green-800 dark:text-green-200'}`}>
                  {formStatus.message}
                </div>
              )}
              ...
              <button
                ...
                className={`w-full py-3 px-6 text-white bg-blue-600 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
